...
from core.run import windows

class Windows(ctk.CTkFrame):
    def __init__(self, master):
        ...
        self.stop = ctk.CTkButton(self.buttons, text="Stop", fg_color="#D32F2F", hover_color="#9A0007", command=windows.stop)
