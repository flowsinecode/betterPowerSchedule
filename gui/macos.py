...
from core.run import macos

class macOS(ctk.CTkFrame):
    def __init__(self, master):
        ...
        self.stop = ctk.CTkButton(self.buttons, text="Stop", fg_color="#D32F2F", hover_color="#9A0007", command=macos.stop)
    ...
    def start(self):
        ...
        macos.start(self.timetostart, self.action_option.get(), self.comment.get())